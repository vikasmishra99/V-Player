...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.helpers.loadImage
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.helpers.loadPlaylistImageWithWidth
...
class CardPresenter(private val context: Activity) : Presenter() {
    ...
    companion object {
        ...
        private val CARD_WIDTH = VideoPlayerApplication.appResources.getDimensionPixelSize(R.dimen.tv_grid_card_thumb_width)
        private val CARD_HEIGHT = VideoPlayerApplication.appResources.getDimensionPixelSize(R.dimen.tv_grid_card_thumb_height)
