...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.audio.AudioPagerAdapter
...
class AboutFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val aboutPolicy = view.findViewById<NestedScrollView>(R.id.about_policy)
        //val webView = view.findViewById<WebView>(R.id.webview)
        //val revision = getString(R.string.build_revision)

        val lists = arrayOf(aboutMain, aboutPolicy)
        val titles = arrayOf(getString(R.string.about),getString(R.string.policy_heading))
