...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.databinding.SendCrashActivityBinding
        ...
        launch(start = CoroutineStart.UNDISPATCHED) {
            val emailIntent = withContext(Dispatchers.IO) {
                ...
                if (!::logcatZipPath.isInitialized) {
                    val path = VideoPlayerApplication.appContext.getExternalFilesDir(null)?.absolutePath ?: return@withContext null
