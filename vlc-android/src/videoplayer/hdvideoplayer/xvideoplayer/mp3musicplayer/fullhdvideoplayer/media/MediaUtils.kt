package videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.media
...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.dialogs.SubtitleDownloaderDialogFragment
...
object MediaUtils : CoroutineScope {
    ...
    fun openMediaNoUi(uri: Uri) = openMediaNoUi(VideoPlayerApplication.appContext, MLServiceLocator.getAbstractMediaWrapper(uri))
    ...
    fun getContentMediaUri(data: Uri) = try {
        VideoPlayerApplication.appContext.contentResolver.query(data,
    ...
    fun retrieveMediaTitle(mw: AbstractMediaWrapper) = try {
        VideoPlayerApplication.appContext.contentResolver.query(mw.uri, null, null, null, null)?.use {
