...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.BetaWelcomeActivity
...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.helpers.hf.StoragePermissionsDelegate.Companion.getStoragePermission
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.onboarding.ONBOARDING_DONE_KEY
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.onboarding.startOnboarding
...
class StartActivity : FragmentActivity(), CoroutineScope by MainScope() {
    ...
    private fun resume() {
        ...
        if (Intent.ACTION_SEARCH == action || "com.google.android.gms.actions.SEARCH_ACTION" == action) {
            startActivity(intent.setClass(this, if (tv) videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.tv.SearchActivity::class.java else SearchActivity::class.java))
            finish()
            return
