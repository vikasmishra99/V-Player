...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.SendCrashActivity
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.dialogs.VlcProgressDialog
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.helpers.AudioUtil
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.helpers.BitmapCache
...
class VideoPlayerApplication : MultiDexApplication() {
        ...
        Thread(Runnable {
            ...
            runIO(Runnable {
                if (AndroidUtil.isOOrLater)
                    NotificationHelper.createNotificationChannels(this@VideoPlayerApplication)
    ...
    companion object {
        private const val TAG = "VLC/VideoPlayerApplication"

        const val ACTION_MEDIALIBRARY_READY = "VLC/VideoPlayerApplication"
