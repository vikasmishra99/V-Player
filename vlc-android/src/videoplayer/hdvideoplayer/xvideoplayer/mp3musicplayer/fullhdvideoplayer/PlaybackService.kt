...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.helpers.NotificationHelper
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.video.PopupManager
        ...
        override fun handleMessage(msg: Message) {
            ...
            when (msg.what) {
                SHOW_TOAST -> {
                    ...
                    Toast.makeText(VideoPlayerApplication.appContext, text, duration).show()
                }
    ...
    private fun broadcastMetadata() {
        ...
        launch(Dispatchers.Default) {
            sendBroadcast(Intent("com.android.music.metachanged")
                    ...
                    .putExtra("package", "videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer"))
        }
    }
