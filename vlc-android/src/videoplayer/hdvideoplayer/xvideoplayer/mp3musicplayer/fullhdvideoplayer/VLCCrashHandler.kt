...
class VLCCrashHandler : UncaughtExceptionHandler {
    ...
    override fun uncaughtException(thread: Thread, ex: Throwable) {
        ...
        if (Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED) {
            writeLog(stacktrace, VideoPlayerApplication.appContext.getExternalFilesDir(null)!!.absolutePath + "/vlc_crash")
            writeLogcat(VideoPlayerApplication.appContext.getExternalFilesDir(null)!!.absolutePath + "/vlc_logcat")
        }
