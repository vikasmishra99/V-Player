...
object FileUtils {
    ...
    fun getPathFromURI(contentUri: Uri): String {
        ...
        try {
            ...
            cursor = VideoPlayerApplication.appContext.contentResolver.query(contentUri, proj, null, null, null)
    ...
    fun deleteFile(file: File): Boolean {
        ...
        if (file.isDirectory) {
            ...
            val cr = VideoPlayerApplication.appContext.contentResolver
            try {
    ...
    fun findFile(uri: Uri): DocumentFile? {
        uri.path?.let { path ->
            val context = (VideoPlayerApplication.appContext as Context?) ?: return null
    ...
    fun getUri(data: Uri?): Uri? {
        var uri = data
        val ctx = VideoPlayerApplication.appContext
    ...
    fun getStorageTag(uuid: String): String? {
        ...
        try {
            val storageManager = VideoPlayerApplication.appContext.getSystemService(StorageManager::class.java)
