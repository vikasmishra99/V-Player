...
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.VLCCrashHandler
import videoplayer.hdvideoplayer.xvideoplayer.mp3musicplayer.fullhdvideoplayer.gui.CompatErrorActivity
...
object VLCInstance {
    ...
    fun restart() {
        if (sLibVLC != null) {
            sLibVLC!!.release()
            sLibVLC = LibVLC(VideoPlayerApplication.appContext, VLCOptions.libOptions)
        }
    }
